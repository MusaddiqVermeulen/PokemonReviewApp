...
namespace PokemonReviewApp.Controllers
{
    ...
    public class OwnerController : Controller
    {
        ...
        [ProducesResponseType(400)]
        public IActionResult CreateOwner([FromQuery] int countryId, [FromBody] OwnerDto ownerCreate)  // FromBody takes in data form the body
        {
            if (ownerCreate == null)
                return BadRequest(ModelState);
        ...
        public IActionResult DeleteOwner(int ownerId)
        {
            ...
            {
                ModelState.AddModelError("", "Something went wrong when deleting the owner");
            }
